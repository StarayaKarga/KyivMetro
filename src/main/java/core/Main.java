...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Програма розрахунку маршрутів метрополітену Київа\n");
        ...
        for(;;)
        {
            ...
            System.out.println("Тривалість: " +
                    RouteCalculator.calculateDuration(route) + " хвилин");
        }
    }
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            System.out.println("Станція не знайдена, спробуйте ще раз :(");
        }
    }
